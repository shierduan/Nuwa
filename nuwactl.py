...
def check_and_install_dependencies():
    ...
    for dep_name, import_name in required_deps:
        try:
            ...
            print_info(f"[OK] {dep_name} 已安装")
        except ImportError:
            missing_deps.append(dep_name)
            print_warning(f"[WARN] {dep_name} 未安装")
...
def start_service():
    ...
    try:
        ...
        try:
            import yaml
            print_info(f"[OK] pyyaml 已安装")
        except ImportError:
            print_info("[WARN] pyyaml 未安装")
        try:
            import psutil
            print_info("[OK] psutil 已安装")
        except ImportError:
            print_info("[WARN] psutil 未安装")
...
def dev_mode():
    ...
    for dep in dev_deps:
        try:
            __import__(dep)
            print_info(f"[OK] {dep} 已安装")
        except ImportError:
            missing_deps.append(dep)
            print_warning(f"[ERROR] {dep} 未安装")
