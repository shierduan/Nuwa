...
> 从土木行业裸辞，曾参加信通院人工智能所AI安全研究员方向终面，遗憾未能获得offer，但衷心感谢所里和院里给予的高额劳务报酬。
> 
> 虽然这只是一个原型，但它代表了尝试以数学/控制论等构建伪数字生命的一次有意义尝试。如果你也对"赋予 AI 生命"感兴趣，欢迎加入我们。
...
- **黎曼几何**：为语义场提供数学严格性
- **强化学习（PPO/Q-Learning）**：为自适应控制和自我进化提供优化方法
- **记忆整理和语义检索算法**：为记忆系统提供支持
- **Plutchik 情感模型**：为 13 维情感状态空间提供心理学基础
